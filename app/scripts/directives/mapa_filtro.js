  ...
  .directive('mapaFiltro', function () {
    return {
      ...
      '<div id="mapa-filtro">'+
        ...
        '<label>Código Establecimiento</label><br/>'+
        '<select id="filtroCodigoEstablecimiento" name="filtroCodigoEstablecimiento" ng-model="local.codigoEstablecimiento" ng-change="updateFiltro(local)"></select><br/>'+
      ...
      link: function postLink(scope, element, attrs) {
        ...
        */
        var cargar = function(establecimientos){
          ...
          var filtros = {periodo:[], departamento:[], distrito:[], barrioLocalidad:[], zona:[], codigoEstablecimiento:[], proyecto111:[]};
